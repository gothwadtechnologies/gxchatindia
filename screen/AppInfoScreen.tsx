    ...
    <div className="h-full flex flex-col bg-[var(--bg-main)] overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar py-10">
        <div className="flex flex-col items-center justify-center mb-12">
          ...
          <h2 className="text-2xl font-black text-[var(--text-primary)] tracking-tight italic">GxChat India</h2>
        ...
        <div className="bg-[var(--bg-card)] border-y border-[var(--border-color)]">
          <div className="px-6 py-5 border-b border-[var(--border-color)]">
            ...
            <p className="text-xs text-[var(--text-secondary)] leading-relaxed ml-12">
              Your messages and calls are secured with end-to-end encryption. No one outside of this chat, not even GxChat India, can read or listen to them.
            </p>
          </div>
          ...
          <div className="px-6 py-5 border-b border-[var(--border-color)]">
            ...
            <p className="text-xs text-[var(--text-secondary)] leading-relaxed ml-12">
              Proudly developed and maintained by Gothwad Technologies in India.
            </p>
          </div>
