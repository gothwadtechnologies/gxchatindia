...
export default function GxChatAIProfile() {
    ...
    <div className="flex flex-col h-full bg-[var(--bg-main)] overflow-y-auto no-scrollbar">
      ...
      <div className="px-4 py-8 flex flex-col items-center text-center border-b border-[var(--border-color)] bg-gradient-to-b from-[var(--primary)]/5 to-transparent">
        ...
        <div className="flex items-center gap-2 mb-1">
          <h2 className="text-2xl font-black text-[var(--text-main)] tracking-tight">GxChat AI</h2>
          <CheckCircle2 size={20} className="text-[var(--primary)] fill-[var(--primary)]/10" />
        </div>
        <p className="text-[var(--text-secondary)] font-medium mb-4">@gxchatai • Official Assistant</p>
      ...
      <div className="px-4 py-6 space-y-6">
        <section>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-black text-[var(--text-main)] uppercase tracking-tight text-sm">About GxChat AI</h3>
          </div>
          <p className="text-sm text-[var(--text-secondary)] leading-relaxed font-medium bg-[var(--bg-card)] p-4 rounded-2xl border border-[var(--border-color)]">
            Hello! I am GxChat AI, your personal intelligent assistant. I'm powered by advanced language models to help you with questions, coding, creative writing, and much more. I'm available 24/7 to make your GxChat experience even better.
          </p>
        </section>
