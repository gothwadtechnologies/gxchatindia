...
export default function PrivacySettingsScreen() {
  ...
  const settings = [
    ...
    },
    {
      ...
      icon: Lock,
      label: 'App Lock',
      sub: 'Require PIN to open GxChat India',
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar py-6">
        ...
        <div className="bg-[var(--bg-card)] border-y border-[var(--border-color)] mb-6 p-6">
          ...
          <p className="text-[11px] text-[var(--text-secondary)] leading-relaxed font-medium text-center px-4">
            {isPrivate 
              ...
              : "Public accounts are visible to everyone on GxChat India. Anyone can follow you and see your posts."
            }
          </p>
        </div>
        ...
        <div className="px-6">
          <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-2xl p-4 flex gap-4">
            ...
            <p className="text-[11px] text-emerald-600 font-medium leading-relaxed">
              GxChat India uses end-to-end encryption. Your privacy is our priority. Never share your credentials.
            </p>
          </div>
        </div>
        ...
        <div className="py-12 flex flex-col items-center gap-1 opacity-40">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[var(--text-primary)] text-[9px] font-black tracking-[0.2em] uppercase">GxChat India Privacy</span>
          </div>
