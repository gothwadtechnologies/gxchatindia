        ...
        {success ? (
          ...
          >
            ...
            <div className="space-y-2">
              <h3 className="text-lg font-bold text-zinc-900">Email Sent!</h3>
          ...
          <form onSubmit={handleResetPassword} className="space-y-6">
            ...
            {error && (
              <motion.p 
                ...
                className="text-red-500 text-xs font-bold text-center bg-red-50 py-3 rounded-xl flex items-center justify-center gap-2 px-4"
              >
                <AlertCircle size={14} />
                {error}
              </motion.p>
            ...
            <div className="text-center pt-4">
              <Link to="/login" className="text-xs font-bold text-zinc-500 hover:text-zinc-800">
                Remember your password? <span className="text-zinc-800 hover:underline">Sign in</span>
              </Link>
            </div>
          </form>
        )}
