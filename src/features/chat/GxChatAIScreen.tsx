...
export default function GxChatAIScreen() {
  ...
  const clearChat = () => {
    if (window.confirm('Clear all messages with GxChat AI?')) {
    ...
    <div className="flex flex-col h-full bg-[var(--bg-main)]">
      ...
      <div className="h-14 bg-[var(--header-bg)] flex items-center px-4 gap-3 z-50 shrink-0 border-b border-[var(--border-color)] shadow-sm rounded-b-2xl">
        ...
        <div className="flex-1 flex items-center gap-3">
          ...
          <div>
            <h2 className="text-[15px] font-black text-[var(--header-text)] leading-tight">GxChat AI</h2>
